...
app.post('/compute',
  ...
  function (req, res) {
    ...
    //   });
      ...
      var consoleStorage = [];
      page.set('onConsoleMessage', collectConsole.bind(this, consoleStorage, 'log'));
      // page.set('onLoadFinished', collectConsole.bind(this, consoleStorage, 'loaded'));
      page.set('onError', collectConsole.bind(this, consoleStorage, 'error'));
        ...
        utils.waitFor(function (cb) {
          ...
          .then(function () {
            page.evaluate(function () {
              ...
              consoleStorage.forEach(function(v) {
                res.append('x-phantomas-' + (v.severity || 'debug'), JSON.stringify(v.message));
              });
              res.send(answer);
            });
          })
          .catch(function (e) {
            ...
            res.append('x-phantomas-internal-error', e.message);
...
function collectConsole(storage, severity) {
  storage.push({
    severity,
